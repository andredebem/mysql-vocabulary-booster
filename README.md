...
Os desafios deste projeto foram criados com o intuito de praticar a criação de queries mais elaboradas no MySQL, utilizando, muitas vezes, diferentes comandos em uma mesma query.

Foram utilizados dois bancos de dados: o `hr` e o `w3schools`.
...
1. Acesse o mesmo link deste repositório com `1s` depois de `github` e antes de `.com`
  * `https://github1s.com/andredebem/mysql-vocabulary-booster`
